        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                    <img src="{{ asset('images/logo-mpanjaka.png') }}" alt="Logo de l'association" class="block h-9 w-auto">
                    </a>
                </div>
...
<div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
    ...
    {{-- ... --}}
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                 @guest
                    <a href="{{ route('login') }}" class="text-sm font-semibold text-gray-700 hover:text-red-600">Se connecter</a>
                    <a href="{{ route('register') }}" class="ms-4 text-sm font-semibold bg-red-600 text-white hover:bg-red-700 px-4 py-2 rounded-md">S'inscrire</a>
                 @else
